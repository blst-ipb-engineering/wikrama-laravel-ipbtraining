					...
					<form method="post" id="err" name="err">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-select" >
                                <select name="training_title" data-dependent="training_title" data-ajax-input="training_title" id="training_title" class="form-event">
                                    <option value=""></option>
                        ...
                        <br>
                           ...
                           <div class="form-select" >
                            <select name="participant_name" id="participant_name" data-ajax-input="participant_name"  class="form-event" data-dependent="participant_name"  value="{{ old('participant_name') }}">
						...
						<div class="form-group">
                            ...
                            <label class="label"></label>
                            <center><textarea class="form-input" name="kesan" data-ajax-input="kesan" rows="1" cols="30" placeholder="Jawaban Anda" >{{old('kesan')}}</textarea></center>
                        ...
                        <div class="form-group">
                            ...
                            <br>
                            <center><input type="text" class="form-input" name="merekomendasikan" id="recommend" data-ajax-input="merekomendasikan" placeholder="Isi dengan nama dan no. Hp teman anda" value="{{old('merekomendasikan')}}" /></center>
