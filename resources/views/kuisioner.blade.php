  ...
  <div class="container-sm">
    ...
    <div class="row" id="kinerja">
      <div class="col-sm-12 mt-5 text-center">
        ...
        <textarea type="text" class="form-control" name="kinerjaKomen" required></textarea>
      </div>
    </div>
    ...
    <div class="row" id="fasilitas">
      <div class="col-sm-12 mt-5 text-center">
        ...
        <textarea type="text" class="form-control" name="fasilitasKomen" required></textarea>
      </div>
    </div>
    ...
    <div class="row" id="attitude">
      <div class="col-sm-12 mt-5 text-center">
        ...
        <h3 class="mt-4">Komentar terkait layanan panitia</h3>
        <textarea type="text" class="form-control" name="attitudeKomen" required></textarea>
      </div>
    </div>
