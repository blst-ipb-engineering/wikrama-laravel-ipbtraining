   ...
   {{ csrf_field() }}
    ...
    <div class="row" id="kinerja">
      <div class="col-sm-12 mt-5 text-center">
        ...
        <img class="star" v-if="star1" src="/images/pertanyaan/star.png" alt="" v-on:click="toggle1">

        <img class="star" v-if="!star2" src="/images/pertanyaan/star-empty.png" alt="" v-on:click="toggle2">
        <img class="star" v-if="star2" src="/images/pertanyaan/star.png" alt="" v-on:click="toggle2">

        <img class="star" v-if="!star3" src="/images/pertanyaan/star-empty.png" alt="" v-on:click="toggle3">
        <img class="star" v-if="star3" src="/images/pertanyaan/star.png" alt="" v-on:click="toggle3">

        <img class="star" v-if="!star4" src="/images/pertanyaan/star-empty.png" alt="" v-on:click="toggle4">
        <img class="star" v-if="star4" src="/images/pertanyaan/star.png" alt="" v-on:click="toggle4">
